...
\begin{proposition}
	A bimonoid structure on a horizontal morphism $(E,\eta,\epsilon)\colon C\to C$ in $\FFD$ is precisely a weak factorization system on $C$ with underlying functorial factorization system $(E,\eta,\epsilon)$. 
\end{proposition}
\begin{proof}
...
\begin{proposition}
	Morphisms in $\mathrm{Bimon}(\FFD)$ are precisely the colax morphisms of awfs.
\end{proposition}
\begin{proof}
