...
The canonical example of a cyclic multicategory is $\MAdjC$, whose objects are categories, and morphisms are multivariable mutual left adjoints. For example, consider an adjunction of two variables
\[
\begin{tikzcd}
